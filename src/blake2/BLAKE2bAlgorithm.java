 ...
 * Uses source code from the BLAKE-512 project.
 * 
 * To the extent possible under law, the author(s) have dedicated all copyright
 * and related and neighboring rights to this software to the public domain
 * worldwide. This software is distributed AS-IS without any warranty, implied
 * or explicit.
 *
...
public class BLAKE2bAlgorithm{
	...
	private byte[] emptyArray = new byte [128];
	...
	public void Initialize()
	{
		...
		//workaround because it throws an exception the other way.
		_buf = emptyArray;
